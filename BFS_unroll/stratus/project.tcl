...
define_hls_module BFS ../BFS.cpp

### 4. Define your HLS configuration (arbitrary names, BASIC and DPA in this example). 
define_hls_config BFS BASIC
define_hls_config BFS DPA       --dpopt_auto=op,expr
...
define_sim_config V_BASIC "BFS RTL_V BASIC"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "BFS RTL_V DPA"
